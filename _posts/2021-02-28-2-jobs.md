---
layout: post
title: "Acquiring Data from regulations.gov (Jobs)"
author: William Jobs
...
| ![GitHub discussion](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-001-github.png?raw=TRUE) | 
|:--:| 
...
| ![API response](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-002-jsonreponse.png?raw=TRUE) | 
|:--:| 
...
| ![metadata](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-003-metadata.png?raw=TRUE) | 
|:--:| 
...
| ![spurious dates](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-004-posteddates.png?raw=TRUE) | 
|:--:| 
...
| ![dockets per year and month](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-005-docketsperyear.png?raw=TRUE) | 
|:--:| 
...
| ![comments per year and month](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-006-commentsperyear.png?raw=TRUE) | 
|:--:| 
...
| ![documents per month](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-007-documentspermonth.png?raw=TRUE) | 
|:--:| 
...
| ![document types per two year period](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-008-documenttypes.png?raw=TRUE) | 
|:--:| 
...
| ![time zone error](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-009-timezone1.png?raw=TRUE) | 
|:--:| 
...
| ![time zone request](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-010-timezone2.png?raw=TRUE) | 
|:--:| 
...
| ![time zone issue](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-011-timezone3.png?raw=TRUE) | 
|:--:| 
...
| ![time zone mention](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-012-timezone4.png?raw=TRUE) | 
|:--:| 
...
| ![sqlite issue](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-013-sqlite.png?raw=TRUE) | 
|:--:| 
...
| ![many docs without comments](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-014-download.png?raw=TRUE) | 
|:--:| 
...
| ![comment without text](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-015-notext.png?raw=TRUE) | 
|:--:| 
...
| ![log of output handling rate limits](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-016-log.png?raw=TRUE) | 
|:--:| 
...
| ![comment caps](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-017-commentcap.png?raw=TRUE) | 
|:--:| 
...
| ![comment columns and data](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-018-commentcols.png?raw=TRUE) |
|:--:|
| *Listing of comment columns, types, and example values.* |

<br>

| ![document columns and data](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-019-documentcols.png?raw=TRUE) |
|:--:|
| *Listing of document columns, types, and example values.* |

<br>

| ![docket columns and data](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-02-020-docketcols.png?raw=TRUE) |
|:--:|
