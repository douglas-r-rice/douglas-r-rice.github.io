---
layout: post
title: "Form Letter Identification via Supervised Learning (Jobs)"
author: William Jobs
...
<img alt="updated sampling summary" src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-001-sampling.png?raw=TRUE" width="600" />
...
![updated duplicates by year](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-002-duplicate-comments-byyear.png?raw=TRUE)
...
![updated inter-document comment similarity](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-003-similarity_samedoc_nondupe_gt2.png?raw=TRUE)

<br>

![updated intra-document comment similarity](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-004-similarity_otherdoc_simulation.png?raw=TRUE)
...
| ![Form letter calling out a form letter](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-005-formletter.png?raw=TRUE) | 
|:--:| 
...
<img alt="correlations" src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-006-data_correlations.png?raw=TRUE" width="600" />
...
<img alt="logistic regression, all variables, ROC curve" src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-007-logit_all_roc_curve.png?raw=TRUE" width="600" />
...
![logistic regression, all variables, variable importance](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-008-logistic_all_varimp.png?raw=TRUE)
...
![logistic regression coefficients](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-009-logistic-coefficients.png?raw=TRUE)
...
![logistic regression, stepwise, variable importance](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-010-logistic_stepwise_varimp.png?raw=TRUE)
...
<img alt="tuning random forest" src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-011-random_forest_all_tuning.png?raw=TRUE" width="600" />
...
<img alt="random forest ROC curve" src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-012-randomforest_all_roc_curve.png?raw=TRUE" width="600" />

<br>

![random forest variable importance](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-013-randomforest_all_varimp.png?raw=TRUE)
...
![random forest subset variable importance](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-014-randomforest_subset_varimp.png?raw=TRUE)

<br>

A summary of the four models' performance is given in the table below.

![model summary](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-015-model-summary.png?raw=TRUE)
...
![highly different form letter comments](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-017-diff.png?raw=TRUE)
...
![confident vs not, predictors](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-018-logit_probs_unsure_vs_confident.png?raw=TRUE)
...
![song](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-019-song.png?raw=TRUE)

<br>

![play](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/jobs-005-020-play.png?raw=TRUE)
