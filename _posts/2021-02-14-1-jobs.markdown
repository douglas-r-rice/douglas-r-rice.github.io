...
| ![illustration of rule process](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/001_illustration.png?raw=TRUE) | 
|:--:| 
...
| ![comparison of sites](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/002_comparison.png?raw=TRUE) | 
|:--:| 
...
| ![a docket](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/003_docket.png?raw=TRUE) | 
|:--:| 
...
| ![example listing of comment](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/004_example_listing.png?raw=TRUE) | 
|:--:| 
| *An [example listing](https://beta.regulations.gov/document/FWS-HQ-ES-2020-0102-0001/comment) of comments for one docket.* |

<br>

| ![example comment](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/005_example_comment.png?raw=TRUE) | 
|:--:| 
| *An [example of a comment](https://beta.regulations.gov/comment/FWS-HQ-ES-2020-0102-6515) for one docket.* |

<br>

| ![comment submission form](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/006_comment_submission.png?raw=TRUE) | 
|:--:| 
...
| ![commenter's checklist](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/007_commenter_checklist.png?raw=TRUE) | 
|:--:| 
...
| ![Many identical comments in response to one rule](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/008_boone_crockett.png?raw=TRUE) | 
|:--:| 
...
| ![earliest comment](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/009_earliest_comment.png?raw=TRUE) | 
|:--:| 
...
| ![early typewritten comment](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/010_early_typewritten.png?raw=TRUE) | 
|:--:| 
...
| ![typewritten letter](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/011_typewritten.png?raw=TRUE) | 
|:--:| 
...
| ![plain-text comment](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/012_plaintext.png?raw=TRUE) | 
|:--:| 
...
| ![teamsters comment](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/014_teamsters.png?raw=TRUE) | 
|:--:| 
...
<figure>
<img src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/013_example1.png?raw=TRUE" alt="example comment" />
<br>
<img src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/013_example2.png?raw=TRUE" alt="example comment" />
<br>
<img src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/013_example3.png?raw=TRUE" alt="example comment" />
<br>
<img src="https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/013_example4.png?raw=TRUE" alt="example comment" />
</figure>
...
| ![influence explorer article](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/015_article.png?raw=TRUE) | 
|:--:| 
...
| ![bulk data page](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/016_bulk_data.png?raw=TRUE) | 
|:--:| 
| *[Bulk Data](https://sunlightlabs.github.io/datacommons/bulk_data.html) page on Sunlight Labs' GitHub site.* |

<br>

| ![Bulk Data page section on federal regulations](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/017_bulk_regs.png?raw=TRUE) | 
|:--:| 
...
| ![web archive listing](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/018_web_archive.png?raw=TRUE) | 
|:--:| 
...
| ![broken links](https://github.com/douglas-r-rice/douglas-r-rice.github.io/blob/main/_posts/images/019_broken_link.png?raw=TRUE) | 
|:--:| 
